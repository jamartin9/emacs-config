...
** movies
- https://caps-a-holic.com/c.php?https://caps-a-holic.com/c.php?a=1&x=603&y=301&d1=15009&d2=5245&s1=156558&s2=49011&l=0&i=2&go=1 UHD issues in LotR
- Mousehunt has a teal filter on BD but not web
...
mediainfo makemkv mkvmerge ffmpeg awsmfunc vs-preview-rs x265 x264 dovi_tool dolby-encoder
...
5. Extract the sources with Dolby Vision enhancement layers using dovi tool
...
16. Encode the audio to DD+ with dolby-encoding (ffmpeg produces sub par ac3)
17. Combine source subtitles into the container with mkvmerge
18. Align chapters to scenecuts with MKVmerge
19. The file name should be of the form NAME.YEAR.RESOLUTION.SOURCE.AUDIO.VIDEO.mkv
