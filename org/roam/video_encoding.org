...
Bluray - Chapter names (get from dvd edit with mkvtoolsnix), compare bitrates of sources, cinavia protection(transcode audio or use dvds). BT.709 colorspace 8 bit, m2ts
