...
- Coral and DBT for lakehouse query translation and incremental views
- q-hierarchial queryies without self-joins can be factored for faster enumeration updates in incremental views
** notes
