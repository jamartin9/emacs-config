...
- qemu
  ...
  - add ~-bios /usr/share/ovmf/x64/OVMF.4m.fd~ for uefi boot
...
- SR-IOV for splitting single pcie device into multiple for gpu vm sharing
  - https://github.com/strongtz/i915-sriov-dkms for i915 dkms module sharing
