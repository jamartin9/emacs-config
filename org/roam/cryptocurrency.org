...
- Trademark trolling chiaplot (new site)/xchscan(block explorer) with fresh law grad
  - the chia plot needed a lawyer for them to buzz off
- large premine (promised to not use) is not being used
...
- Slow development
  ...
  - blockchain download (offer torrent now)
* monero
