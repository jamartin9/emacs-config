...
- multi modal models (ViTS) combine visual and image
...
** Large Language Models
  ...
  - [[https://github.com/facebookresearch/llama][Llama]] (chinchilla optimal) recreated 3B and 7B as [[https://huggingface.co/togethercomputer/RedPajama-INCITE-Chat-3B-v1][RedPajama]]
