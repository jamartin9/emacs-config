...
** image generation
  ...
  - [[https://github.com/hlky/stable-diffusion][stable diffusion]]
    ...
    - fine tune with [[https://github.com/cloneofsimo/lora][lora]]
** Large Language Models
  - [[https://github.com/facebookresearch/llama][Llama]]
    ...
    - [[https://github.com/tloen/llama-int8][int8 patch]]
      - [[https://github.com/ggerganov/llama.cpp][ggml is 4 bit and cpu]]
        - set params to ~top_k=40~, ~temperature=0.7~, ~top_p=0~ and a repeat penalty ~repeat_last_n=64~ and ~repeat_penalty=1.3~
    - [[https://github.com/antimatter15/alpaca.cpp][Alpaca]] is [[https://github.com/tatsu-lab/stanford_alpaca][refined by standford]] for chat
      - [[https://github.com/lm-sys/FastChat][Vicuna]] is refined alpaca with sharegpt
