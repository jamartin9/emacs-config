...
- transformers context length prediction can be expanded from the size used in training by using [[https://arxiv.org/pdf/2108.12409.pdf][ALiBi]] (or 0.5 scale on the positional embeddings like in SUPERHOT?)
