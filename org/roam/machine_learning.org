...
** Large Language Models
  ...
  - [[https://github.com/ggerganov/llama.cpp][llama.cpp gguf is 4 bit and cpu]] (adding more gpu and 3/5/6 bit quant)
    - ik_llama.cpp fork with cpu/quant improvements
      - ~-mtp~ ~--draft-max 10 --draft-p-min 0.85~ for mtp speculative decoding (poor perf with moe as memory bandwidth bound) and does not support qwen3.5 mtp yet...
...
# quantized: bnb gives 0.5 tk/s and torachao Int8DynamicActivationInt8WeightConfig() gives 3.5 tk/s, 1.5 with weight_only v2 8 tk/s plain. Int8DynamicActivationIntxWeightConfig 4bit weight gives ~2 tk/s. Int4WeightOnly gives does not support. Vino does not support yet. vllm does not support yet.
