...
- ClementTsang/bottom
  - use the ~debug!~ macro to get a log file
  - [[https://github.com/ClementTsang/bottom/commit/48f13b24ee55389ad00863c32398ec26241c3a6f][added zfs arc support]]
    - enables more arc and disk io stats in future
    - enables more freebsd/mac/old linux metrics with sysctl
      - freebsd used sysctl support for hw temp sensors and zfs
  ...
  - [[https://github.com/ClementTsang/bottom/pull/794][added gpu vram support]]
    - hide swap when not used in basic mode and bugfixed freebsd build / percentage toggle
    - enables gpu power and processes information
  ...
  - [[https://github.com/ClementTsang/bottom/pull/1276][added gpu process, power and utilization support]]
    - bugfixed battery out of bounds in same pr
    - maintainer chose to remove util/power until separate widget
      - future gpu widget will probably use the gpu data from vram upon removal from the memory widget
- wine/wine
