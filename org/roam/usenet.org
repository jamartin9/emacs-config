...
* usenet
** usenet notes
- http://csiph.com/ for text browsing
- https://github.com/javi11/postie is wip poster
...
- usenet archives
  ...
  - nzbget for downloading binaries
    ...
    - set ParCheck to Force to enable all pars to download (so provider can retain)
      - set ~WebDir=/home/jam/.guix-profile/share/nzbget/webui~ and ~ConfigTemplate=/home/jam/nzbget-template.conf~ in ~~/.nzbget~
        - copy ~~/.guix-profile/share/nzbget/nzbget.conf~ for template
...
- backbones
  ...
  - abavia
    - hitnews
  - vipernews
    - shares feed with usenet express
