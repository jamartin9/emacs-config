...
- see https://codeberg.org/guix/guix/pulls/1917#issuecomment-6976089 for modern patch based on the script/notes below
  - https://codeberg.org/hako/Rosenthal/ with 2 patches at ~modules/rosenthal/packages/patches~
    - UKI kernel with limine failed on deploy and vm image creation with qcow-gpt
