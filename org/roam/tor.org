...
njallalafimoej5i4eg7vlnqjvmb6zhdh27qxcatdn647jtwwwui3nad.onion is njal
  - njal is pozzed and will remove dns/vps it they do not like your content (flokinet {pozzed by EU [8chan illegal]}, buyvm{crypto only anon}, terrahost{epik}, vsys.host, hostslick) (verisign domain for speech?)
...
https://twitter3e4tixl4xyajtrzo62zg5vztmjuricljdp2c5kshju4avyoid.onion/ is twitter
...
#ClientTransportPlugin obfs4 exec /usr/share/tor/PluggableTransports/obfs4proxy
...
#AllowSingleHopCircuits 1 # MAYBE set self as own Rendezvous point
#+END_SRC
