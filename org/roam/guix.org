  ...
  (home-environment
   (packages (append
            ...
            (map specification->package (list "guile"
                                             ...
                                             "screen"
                                             ;"python" "python-lsp-server" "python-debugpy" "python-pylint" "python-tomli" "emacs-pyvenv" ; "tree-sitter-python"
                                             "tree-sitter-yaml" ; "tree-sitter-rust" ; "tree-sitter" ; "emacs-yaml-mode"; ; "emacs-explain-pause-mode"
                                             "emacs-eat" "emacs-debbugs" "emacs-org-roam" "emacs-flycheck-popup-tip" "emacs-rmsbolt" "emacs-guix" "emacs-emms" "emacs-osm" "emacs-minions" "emacs-transmission" "emacs-undo-tree" "emacs-pass" "emacs-password-store-otp" "emacs-code-review" "emacs-orgit-forge" "emacs-macrostep-geiser" "emacs-company" "emacs-lsp-treemacs" "emacs-lsp-ui" "emacs-geiser-guile" "emacs-dap-mode" "emacs-link-hint" "emacs-which-key" "emacs-pcre2el" "emacs-gcmh" "emacs-flymake-guile" "emacs-rust-mode";"emacs-cfrs"; "emacs-fd"; "emacs-flycheck-guile"; "emacs-rustic"
                                             ))))
   (services
    (list
