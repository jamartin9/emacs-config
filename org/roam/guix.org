...
#+BEGIN_SRC scheme :tangle home.scm :noweb yes
  ...
  (home-environment
   (packages (append
            ...
            ;(map transform-emacs-build (list emacs-rmsbolt emacs-pyvenv emacs-eat emacs-debbugs emacs-org-roam emacs-flycheck-guile emacs-guix emacs-fd emacs-emms emacs-osm emacs-minions emacs-transmission emacs-undo-tree emacs-pass emacs-use-package emacs-code-review emacs-orgit-forge emacs-flycheck-popup-tip emacs-macrostep-geiser emacs-company emacs-cfrs emacs-lsp-treemacs emacs-lsp-ui emacs-rustic emacs-geiser-guile emacs-dap-mode emacs-link-hint emacs-which-key emacs-explain-pause-mode emacs-pcre2el emacs-gcmh)) ; BUG no eln
            (map specification->package (list "guile"
                                             ...
                                             "tree-sitter-yaml" ; "tree-sitter-python" ; "tree-sitter-rust" ; "tree-sitter" ; "emacs-yaml-mode"; ; "emacs-flymake-guile"
                                             "emacs-eat" "emacs-debbugs" "emacs-org-roam" "emacs-flycheck-guile" "emacs-flycheck-popup-tip" "emacs-rmsbolt" "emacs-guix" "emacs-emms" "emacs-osm" "emacs-minions" "emacs-transmission" "emacs-undo-tree" "emacs-pass" "emacs-password-store-otp" "emacs-code-review" "emacs-orgit-forge" "emacs-macrostep-geiser" "emacs-company" "emacs-lsp-treemacs" "emacs-lsp-ui" "emacs-rustic" "emacs-geiser-guile" "emacs-dap-mode" "emacs-link-hint" "emacs-which-key" "emacs-explain-pause-mode" "emacs-pcre2el" "emacs-gcmh" "emacs-cfrs" "emacs-fd"
  ...
  %wheel ALL=NOPASSWD: ALL\n"))
    ...
    (services
     (append (list (service xfce-desktop-service-type)
                   ...
                   (service nftables-service-type; MAYBE add guix package for opensnitch: import needs step added for protoc header generation
