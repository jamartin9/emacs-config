...
#+BEGIN_SRC scheme :tangle home.scm
  ...
  (home-environment
   (packages (map specification->package (list "guile"
                                               ...
                                               "emacs-projectile"; remove for builtin
                                               "emacs-project"
                                               "emacs-all-the-icons"
...
;; * TODO guix nvidia-driver(xorg/ko), tor service

(define my-kernel linux-lts)
                          ...
                          (wireguard-configuration
                           ...
                           (peers (list
                                   (wireguard-peer
                                    ...
                                    (public-key "k+ZFm8brFtuVOLUpjQVYdHrCEC5SakGistFjucQa7l4=");; TODO support PSK
...
*** TODO [#C] [PATCH] gnu: wireguard: Add support for PresharedKey :patch:
  [2022-04-21 Thu] Submitted
  :PROPERTIES:
  :DEBBUGS_ID: 55055
  :CREATOR: Paul Alesius <paul@unnservice.com>
  :END:
  [[elisp:(progn (debbugs-org-mode 1) (debbugs-gnu-select-report))][Messages]]
  [2022-04-21 Thu] Last modified
