  ...
  (home-environment
   (packages (append
            ...
            (map specification->package (list "guile"
                                             ...
                                             "emacs-eat" "emacs-debbugs" "emacs-org-roam" "emacs-rmsbolt" "emacs-guix" "emacs-emms" "emacs-osm" "emacs-minions" "emacs-transmission" "emacs-undo-tree" "emacs-pass" "emacs-password-store-otp" "emacs-code-review" "emacs-orgit-forge" "emacs-macrostep-geiser" "emacs-company" "emacs-geiser-guile" "emacs-link-hint" "emacs-which-key" "emacs-pcre2el" "emacs-flymake-guile" "emacs-rust-mode";
                                             ))))
   (services
    (list
