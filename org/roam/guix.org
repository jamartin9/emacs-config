...
#+BEGIN_SRC scheme :tangle home.scm
    ...
    (home-environment
     (packages;(append
              ;(map transform-emacs-build (list emacs-rmsbolt emacs-pyvenv emacs-vterm emacs-debbugs emacs-org-roam emacs-flycheck-guile emacs-flycheck emacs-guix emacs-fd emacs-emms emacs-osm emacs-multiple-cursors emacs-minions emacs-transmission emacs-undo-tree emacs-pass emacs-orgit emacs-magit emacs-use-package emacs-code-review emacs-orgit-forge emacs-flycheck-popup-tip emacs-macrostep-geiser emacs-drag-stuff emacs-company emacs-cfrs  emacs-treemacs emacs-treemacs-extra emacs-lsp-treemacs emacs-lsp-mode emacs-lsp-ui emacs-rustic emacs-geiser emacs-geiser-guile emacs-dap-mode emacs-link-hint emacs-expand-region emacs-which-key emacs-explain-pause-mode emacs-pcre2el emacs-smartparens emacs-gcmh emacs-yaml-mode emacs-forge))
              ;(map transform-emacs-build-git (list emacs-helpful emacs-magit-todos))
              (map specification->package (list "guile"
                                               ...
                                               "python" ; pulled in by treemacs and needed for debugpy module as python3
                                               "python-lsp-server" ; python-lsp
                                               "python-debugpy"
                                               "emacs-pyvenv" "emacs-vterm" "emacs-debbugs" "emacs-org-roam" "emacs-flycheck-guile" "emacs-flycheck" "emacs-rmsbolt" "emacs-guix" "emacs-fd" "emacs-emms" "emacs-osm" "emacs-multiple-cursors" "emacs-minions" "emacs-transmission" "emacs-undo-tree" "emacs-pass" "emacs-orgit" "emacs-magit" "emacs-code-review" "emacs-orgit-forge" "emacs-flycheck-popup-tip" "emacs-macrostep-geiser" "emacs-drag-stuff" "emacs-company" "emacs-treemacs" "emacs-treemacs-extra" "emacs-lsp-treemacs" "emacs-lsp-mode" "emacs-lsp-ui" "emacs-rustic" "emacs-geiser" "emacs-geiser-guile" "emacs-dap-mode" "emacs-link-hint" "emacs-expand-region" "emacs-which-key" "emacs-explain-pause-mode" "emacs-pcre2el" "emacs-smartparens" "emacs-gcmh" "emacs-forge" "emacs-cfrs" "emacs-magit-todos" ;"emacs-helpful"
                                               "emacs-yaml-mode" "emacs-use-package" ; remove emacs-29
                                               )));)
     (services
      (list
    ...
    _guix_vars(){
        if [ -z \"${GUIX_PREV_ENV}\" ]; then # unset vars in guix-home and keep login vars
            export GUIX_PREV_ENV=(\"$(env -u PATH -u GUIX_PROFILE -u GUILE_LOAD_COMPILED_PATH -u GUILE_LOAD_PATH -u SSL_CERT_DIR -u GIT_EXEC_PATH -u GIT_SSL_CAINFO -u INFOPATH -u EMACSLOADPATH -u EMACSNATIVELOADPATH -u BASH_LOADABLES_PATH -u PASSWORD_STORE_SYSTEM_EXTENSION_DIR PATH=/sbin:/bin:/usr/sbin:/usr/bin bash -c '. /etc/profile && env')\")
...
#+BEGIN_SRC scheme :tangle guix-os.scm
  ...
  %wheel ALL=NOPASSWD: ALL\n"))
    ...
    (packages (append (list font-bitstream-vera nss-certs nvi wget blueman cloud-utils); cloud-utils for growpart with resize2fs after img resize
                      %base-packages)) ; podman flatpak
...
** guix pending packages
*** TODO add guix package for mpv with libvdpau-nvidia from nvidia-libs nonguix
**** TODO add guix package for alacritty with nvidia-libs
**** TODO add guix package for httm
- rust version too old with cargo-build-system
**** TODO add guix package for btm
- rust version issue with rust-parking-lot dep
**** TODO add guix package for opensnitch
- import needs step added for protoc header generation
