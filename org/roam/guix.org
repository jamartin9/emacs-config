...
#+BEGIN_SRC scheme :tangle guix-os.scm
    ...
    (operating-system
      ...
      ;(kernel-arguments (append %default-kernel-arguments ("modprobe.blacklist=b43,b43legacy,ssb,bcm43xx,brcm80211,brcmfmac,brcmsmac,bcma,nouveau") ("systemd.unified_cgroup_hierarchy=1")))
