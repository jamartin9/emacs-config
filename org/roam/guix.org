     ...
     (append (list (service xfce-desktop-service-type)
                   ...
                   (service slim-service-type
                            (slim-configuration
                             ...
                             (xorg-configuration
                              (xorg-configuration
                               (modules (cons* xf86-video-qxl; nvidia-driver ;; QXL virtual GPU driver for SPICE and nvidia-xorg
                   ...
                   ;(service plasma-desktop-service-type) ; plasma and sddm login for KDE
...
(operating-system
  ...
  (swap-devices (list (swap-space (target (uuid "a82191d1-c19b-43b3-a4b0-c7d50ca98f58")))))
  ...
  (services
   (append (list (service plasma-desktop-service-type) ; plasma and sddm login for KDE
                 (service sddm-service-type
                           (sddm-configuration
                            (theme "breeze")))
                 (service bluetooth-service-type
