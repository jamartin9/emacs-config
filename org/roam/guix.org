  ...
  (home-environment
   (packages (append
            ...
            (map specification->package (list "guile"
                                             ...
                                             "screen"
                                             "emacs-eat" "emacs-debbugs" "emacs-org-roam" "emacs-guix" "emacs-osm" "emacs-minions" "emacs-transmission" "emacs-undo-tree" "emacs-pass" "emacs-password-store-otp" "emacs-code-review" "emacs-company" "emacs-which-key" "emacs-macrostep-geiser" "emacs-geiser-guile" "emacs-flymake-guile" "emacs-rust-mode" "emacs-yaml-mode" "emacs-pyvenv";"emacs-esup" "emacs-explain-pause-mode" "emacs-pcre2el" "emacs-rmsbolt"
                                             ))))
   (services
    (list
