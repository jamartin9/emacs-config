...
#+BEGIN_SRC scheme :tangle home.scm
  ...
  (home-environment
   (packages (append
            ...
            ;(map transform-emacs-build (list emacs-rmsbolt emacs-pyvenv emacs-eat emacs-debbugs emacs-org-roam emacs-flycheck-guile emacs-guix emacs-fd emacs-emms emacs-osm emacs-multiple-cursors emacs-minions emacs-transmission emacs-undo-tree emacs-pass emacs-use-package emacs-code-review emacs-orgit-forge emacs-flycheck-popup-tip emacs-macrostep-geiser emacs-drag-stuff emacs-company emacs-cfrs emacs-lsp-treemacs emacs-lsp-ui emacs-rustic emacs-geiser-guile emacs-dap-mode emacs-link-hint emacs-expand-region emacs-which-key emacs-explain-pause-mode emacs-pcre2el emacs-smartparens emacs-gcmh)) ; BUG no eln
            (map specification->package (list "guile"
                                             ;"emacs-next-pgtk-xwidgets" ; managed by default profile
                                             "fd"
                                             "git"
                                             "ripgrep"
                                             "nss-certs"
                                             "aspell-dict-en"
                                             ;"mpv"; "vlc"; TODO add guix package for mpv/vlc with libvdpau-nvidia from nvidia-libs nonguix
                                             "gnupg"
                                             "password-store" "pass-otp"
                                             "qemu" ;"virt-viewer"; for spice remote-viewer
                                             "alacritty"; "xterm" ; TODO add guix package for alacritty with nvidia-libs
                                             "curl"; emacs-osm needs for CA's
                                             "screen"
                                             "python" "python-lsp-server" "python-debugpy" "python-pylint" "python-tomli" "emacs-pyvenv"
                                             "tree-sitter-yaml" ; "tree-sitter-python" "tree-sitter-rust" "tree-sitter" ; "emacs-yaml-mode"
                                             "emacs-eat" "emacs-debbugs" "emacs-org-roam" "emacs-flycheck-guile" "emacs-rmsbolt" "emacs-guix" "emacs-emms" "emacs-osm" "emacs-multiple-cursors" "emacs-minions" "emacs-transmission" "emacs-undo-tree" "emacs-pass" "emacs-password-store-otp" "emacs-code-review" "emacs-orgit-forge" "emacs-flycheck-popup-tip" "emacs-macrostep-geiser" "emacs-drag-stuff" "emacs-company" "emacs-lsp-treemacs" "emacs-lsp-ui" "emacs-rustic" "emacs-geiser-guile" "emacs-dap-mode" "emacs-link-hint" "emacs-expand-region" "emacs-which-key" "emacs-explain-pause-mode" "emacs-pcre2el" "emacs-smartparens" "emacs-gcmh" "emacs-cfrs" "emacs-fd"
                                             "emacs-use-package" ; remove emacs-29
                                             ))))
   (services
    (list
...
#+BEGIN_SRC scheme :tangle guix-os.scm
    ...
    ;;   TODO change the %desktop-services elogind-service-type file-system
    ;;                 (file-system
    ;;                   (device "none")
    ...
    (operating-system
      ...
      (kernel-arguments %kicksecure-kernel-arguments);(append %default-kernel-arguments ("modprobe.blacklist=b43,b43legacy,ssb,bcm43xx,brcm80211,brcmfmac,brcmsmac,bcma,nouveau") ("systemd.unified_cgroup_hierarchy=1")))
      ...
      (services
       (append (list (service xfce-desktop-service-type)
                     ...
                     (service cuirass-service-type
                              (cuirass-configuration (specifications #~(list (specification ;; TODO add rss notification
                                                                              (name "my-channel-packages")
                                                                              (build '(packages "rust-bottom" "rust-httm"))
                     ...
                     (service nftables-service-type; TODO add guix package for opensnitch: import needs step added for protoc header generation
