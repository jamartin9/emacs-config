...
gptel/llm-tool-collection/mcp.el: interface with llms. alternative is llm package or cli

dape/geiser-guile/pyvenv/sbt/(rust,yaml,python,scala)-tree-sitter: language specific modes with more than regex.
